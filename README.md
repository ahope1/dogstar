...
The file ***dogstar.ssd*** is a floppy-disc image file (in Acorn DFS format): it contains a copy of the game and can be loaded into a BBC Micro emulator such as BeebEm. The "cheat mode" is new to this BBC Micro port.
